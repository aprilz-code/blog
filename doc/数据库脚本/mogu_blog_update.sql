...
/*
   修改t_system_config 表，增加 searchModel 字段，搜索模式【0:SQL搜索 、1：全文检索】
   @date 2022年1月9日13:50:28
*/

ALTER TABLE `t_system_config`  MODIFY `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间';

ALTER TABLE `t_system_config`  MODIFY `update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间';

ALTER TABLE `t_system_config`  ADD mq_type TINYINT(1) NOT NULL DEFAULT 0 COMMENT '消息队列使用方式 0:RabbbitMq 1:RocketMq';
